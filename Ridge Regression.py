...
plt.title(f'Training Set (Well A) - Ridge Regression - Actual vs Predicted Vs (Km/s) - R2: {r2_train:.4f}')
...
plt.title(f'Ridge Regression - Actual vs Predicted Vs (Km/s) - R2: {r2_test:.4f}')
