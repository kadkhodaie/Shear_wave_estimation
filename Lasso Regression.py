...
plt.title(f'Training Set (Well A) - Lasso Regression - Actual vs Predicted Vs (Km/s) - R2: {r2_train:.4f}')
...
plt.title(f'Lasso Regression - Actual vs Predicted Vs (Km/s) - R2: {r2_test:.4f}')
